                ...
                <div class="sign-window">
                    <div class="window-content">
                        ...
                        <div class="right-content">
                            ...
                            <a href="#" class="button-theme continue-button">Continue</a>
                        </div>
                        <div class="continue-content form">
                            ...
                            <a href="logged.html">
                                <input type="submit" class="hover-effect" value="Sign Up">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="login-window">
                    ...
                    <div class="left-content">
                        ...
                        <div action="" class="form">
                            ...
                            <input type="submit" class="hover-effect" value="Login">
                        </div>
                        <p>Login</p>
                    </div>
                </div>
